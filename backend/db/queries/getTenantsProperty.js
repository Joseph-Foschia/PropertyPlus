...
const getTenantProperty =  (id) => {
  ...
  return db
  .query(`SELECT units.*, leases.start_date as start, leases.rent as lease_rent, tenants.name as tenant_name, landlords.phone_number as landlord_phone, landlords.name as landlords_name 
  FROM units 
